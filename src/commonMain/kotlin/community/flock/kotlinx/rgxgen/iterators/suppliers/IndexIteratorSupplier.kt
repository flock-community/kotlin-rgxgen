...
class IndexIteratorSupplier(private val symbolSetIndexer: SymbolSetIndexer) : Supplier<StringIterator> {
    override fun get(): IndexIterator {
        return IndexIterator(symbolSetIndexer)
    }
}
