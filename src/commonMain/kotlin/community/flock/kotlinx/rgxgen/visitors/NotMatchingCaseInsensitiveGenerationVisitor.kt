...
class NotMatchingCaseInsensitiveGenerationVisitor(
    random: Random,
    groupValues: MutableMap<Int, String>,
    properties: RgxGenProperties<*>?
) : NotMatchingGenerationVisitor(random, groupValues, properties) {
    override fun visit(node: SymbolSet) {
        visitSymbolSet(node, SymbolSet::caseInsensitiveSymbolSetIndexer)
    }

    override fun equalsFinalSymbolRandomString(s1: String, s2: String): Boolean {
